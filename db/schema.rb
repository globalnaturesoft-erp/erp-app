...
ActiveRecord::Schema.define(version: 20161125032957) do
  ...
  create_table "erp_contacts_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_erp_contacts_tags_on_user_id", using: :btree
  end
  ...
  create_table "erp_contacts_titles", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["user_id"], name: "index_erp_contacts_titles_on_user_id", using: :btree
  end
